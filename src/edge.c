...
static void         Edge_add(Edge e, EdgeSL list, EdgeFn fn, void *arg, Name rof, Name fn_name, Name arg_name);
...
void Edge_rise(Edge e, EdgeFn fn, void *arg, Name fn_name, Name arg_name)
{
    Edge_add(e, e->rise, fn, arg, "rise", fn_name, arg_name);
}

void Edge_fall(Edge e, EdgeFn fn, void *arg, Name fn_name, Name arg_name)
{
...
static void Edge_add(Edge e, EdgeSL list, EdgeFn fn, void *arg, Name rof, Name fn_name, Name arg_name)
{
    if (Edge_debug > 0) {
        ...
        if (Edge_debug > 1) {
            STUB(" Edge %s %s calls %s(%s)", e->name, rof, fn_name, arg_name);
        }
    }
    size_t              n = list->count;
